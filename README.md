...
## The system functions as following:
...
## Software used
The project was coded in Keil μVision and flashed onto an STM32 board, with supporting firmware, documentation, and hardware interface code. It combines embedded firmware, sensor reading, actuator control, and a graphical display interface.
